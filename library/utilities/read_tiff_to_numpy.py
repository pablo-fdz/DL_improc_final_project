...
def read_tiff_to_numpy(file_path: str, dtype=np.float32, normalize: bool = False, normalization_method='per_channel') -> np.ndarray:
    """
    Imports tiff images as numpy arrays. Handles NaNs and invalid values and 
